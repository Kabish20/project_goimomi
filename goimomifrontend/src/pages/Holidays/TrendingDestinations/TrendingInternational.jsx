...
export default function TrendingInternational() {
  usePageSEO('Trending International Holidays | Goimomi', 'Discover Bali and Azerbaijan with our curated international holiday packages, detailed itineraries and private transfers.', '/images/bali/bali-nusa-penida-hero.png');
