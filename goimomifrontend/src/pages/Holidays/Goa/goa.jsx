...
export default function Goa() {
  ...
  return <div className="trending-page goa-page">
    ...
    <nav className="ga-nav" aria-label="Goa package sections"><div className="td-container">{[['ga-overview', 'Overview'], ['ga-itinerary', 'Itinerary'], ['ga-hotels', 'Hotels & prices'], ['ga-inclusions', 'Inclusions'], ['ga-info', 'Good to know']].map(([id, label]) => <a href={`#${id}`} key={id}>{label}</a>)}<a href="#ga-enquire" className="ga-nav-enquire-btn">Enquire now <ArrowRight size={14} /></a></div></nav>
