...
import { ArrowLeft, User, Camera, CreditCard, Phone, MessageSquare, Info, FileText } from "lucide-react";
...
const DriverMasterAdd = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            alert("Driver Master created successfully!");
            navigate("/admin/driver-masters");
        } catch (err) {
            console.error("Error creating driver:", err);
            alert("Failed to create driver master.");
        } finally {
            setLoading(false);
        }
    };
                ...
                <div className="flex-1 overflow-y-auto p-4 md:p-6 text-gray-800">
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-8">
                            <div>
                                <h1 className="text-2xl font-black text-gray-900 tracking-tight leading-none mb-2 uppercase">Register New Driver</h1>
                                <p className="text-gray-400 text-[10px] font-bold uppercase tracking-widest">Add a new driver to your master database</p>
                            </div>
                            <button
                            ...
                            <div className="lg:col-span-2 space-y-6">
                                <section className="bg-white rounded-3xl p-6 shadow-sm border border-gray-100">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        ...
                                        <div className="md:col-span-2">
                                            <FormLabel label="Upload ID Copy" optional />
                                                ...
                                                <div className={`w-full h-16 border-2 border-dashed rounded-2xl flex items-center px-6 transition-all ${idCopyName ? 'border-[#14532d]/30 bg-green-50/30' : 'border-gray-100 hover:border-gray-200 bg-gray-50/30'}`}>
                                                    ...
                                                    <div className="ml-4 overflow-hidden">
                                                        ...
                                                        <p className="text-[8px] text-gray-400 uppercase tracking-widest mt-0.5">
                                                            {idCopyName ? "File Attached Successfully" : "Click to browse or drag and drop"}
                                                        </p>
                                                    </div>
                                                    <input
                                                        type="file"
                            ...
                            <div className="space-y-6">
                                <section className="bg-white rounded-3xl p-6 shadow-sm border border-gray-100 sticky top-6">
                                    ...
                                    <div className="aspect-square w-full bg-gray-50 rounded-full border-2 border-dashed border-gray-200 flex flex-col items-center justify-center relative overflow-hidden group hover:border-[#14532d]/30 transition-colors mx-auto max-w-[200px]">
                                        {photoPreview ? (
                                            <img src={photoPreview} className="w-full h-full object-cover transition-transform group-hover:scale-110 duration-500" alt="Driver Preview" />
                                        ) : (
                                        ...
                                        {photoPreview && (
                                            <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                                                <span className="text-white text-[8px] font-black uppercase tracking-[0.2em] border border-white/50 px-3 py-1.5 rounded-full backdrop-blur-sm">Change</span>
                                            </div>
                                        )}
                                    </div>
                                    ...
                                    <div className="mt-6 p-4 bg-blue-50/50 rounded-2xl border border-blue-100/50">
                                        <div className="flex gap-3">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-[9px] text-blue-700/70 leading-relaxed font-medium">Capture a clear, front-facing passport style photo of the driver.</p>
                                            </div>
                                        </div>
                                    </div>
                                </section>
