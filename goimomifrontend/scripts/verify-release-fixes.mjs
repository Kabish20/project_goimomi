...
try {
  ...
  await page.getByRole('button', { name: /Private Leisure/ }).click();
  ...
  await page.locator('.gt-itinerary-photo').scrollIntoViewIfNeeded();
  await page.locator('.gt-itinerary-photo img').evaluate(img => img.decode());
  await page.locator('#packages').screenshot({ path: '../output/release-fixes/golden-triangle-packages.png' });
  await page.evaluate(() => window.scrollTo(0, 0));
  await page.screenshot({ path: '../output/release-fixes/golden-triangle-hero.png' });
  ...
  await page.screenshot({ path: '../output/release-fixes/golden-triangle-mobile-hero.png' });
  await page.locator('.gt-itinerary-photo').scrollIntoViewIfNeeded();
  await page.locator('.gt-itinerary-photo img').evaluate(img => img.decode());
  await page.locator('.gt-enquire-card').screenshot({ path: '../output/release-fixes/golden-triangle-mobile-form.png' });
