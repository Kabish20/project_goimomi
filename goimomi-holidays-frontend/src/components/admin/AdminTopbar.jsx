...
const AdminTopbar = () => {
  ...
  return (
    <div className="bg-[#14532d] text-white px-6 py-1.5 flex justify-between items-center sticky top-0 z-40 shadow-md border-b border-white/5">
      <div className="flex items-center gap-4">
        ...
        <span className="text-[10px] font-black uppercase tracking-widest border-l border-white/10 pl-4 opacity-90">Site Administration</span>
      </div>
      ...
      <div className="flex items-center gap-4 text-[10px]">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="flex items-center gap-1.5 bg-red-500/80 hover:bg-red-600 px-2.5 py-1 rounded-lg transition-all font-black uppercase tracking-wider shadow-sm"
          >
            <LogOut size={12} />
            Exit Admin
          </button>
