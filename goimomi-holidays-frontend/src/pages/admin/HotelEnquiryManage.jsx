...
import api from "../../api";
import { Search, Eye, Trash2, Mail, Phone, Hotel, Edit, Save, X } from "lucide-react";
                    ...
                    <div className="bg-white rounded-2xl shadow-2xl max-w-sm w-full overflow-hidden animate-in fade-in zoom-in duration-200">
                                ...
                                <div className="flex items-center gap-1.5 text-[#14532d] font-bold text-[10px] mt-0.5">
                                    ...
                                    {isEditing ? (
                                        <input 
                                            ...
                                            onChange={handleEditChange} 
                                            className="border border-gray-300 rounded px-1 w-32 outline-none text-gray-700" 
                                        />
                                    ) : (
                        ...
                        <div className="overflow-y-auto max-h-[calc(90vh-140px)]">
                            <div className="p-5 space-y-4">
                                ...
                                <div className="space-y-1.5">
                                    <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest">Stay Requirements</p>
                                ...
                                <div className="pt-1 text-center">
                                    <p className="text-[10px] font-bold text-gray-400 uppercase tracking-tighter">Enquiry received on {formatDate(selectedEnquiry.created_at)}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="p-4 bg-gray-50 flex gap-2 border-t border-gray-100">
                            ...
                            <button
                                ...
                                className="flex-1 bg-[#14532d] text-white py-2.5 rounded-xl font-bold text-sm hover:bg-[#0f3d21] transition-colors shadow-lg shadow-[#14532d]/20"
                            >
                                Email Customer
                            </button>
                        </div>
