                ...
                <div className="p-4">
                    <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                        ...
                        <div className="p-4 border-b border-gray-100 bg-[#14532d] text-white">
                            <h1 className="text-lg font-bold uppercase tracking-wider text-center">Add Umrah Enquiry</h1>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} className="p-4 space-y-4 text-[#333]">
                            ...
                            <div className="space-y-4">
                                <label className="block text-xs font-bold text-gray-700 mb-1 uppercase tracking-tight">Cities *</label>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                                ...
                                <div className="relative">
                                    <label className="block text-xs font-bold text-gray-700 mb-1 uppercase tracking-tight">Number of Travelers *</label>
                                    <div
