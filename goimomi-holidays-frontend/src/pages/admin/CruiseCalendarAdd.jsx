...
const CruiseCalendarAdd = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setError(`Failed to add cruise calendar entry: ${err.response?.data?.message || err.message}`);
        } finally {
            setLoading(false);
        }
    };
                        ...
                        <div className="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-200">
                            <div className="bg-[#14532d] p-6 text-white">
                                <h1 className="text-2xl font-bold flex items-center gap-3">
                                    <Calendar />
                                    Add New Cruise Calendar Entry
                                </h1>
                                <p className="text-green-100 mt-1">Enter the details for the new cruise schedule.</p>
                            </div>
                            ...
                            <form onSubmit={handleSubmit} className="p-8">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                                    <div className="space-y-2">
                                        ...
                                        <input
                                            ...
                                            placeholder="e.g. Cordelia, Jalesh, etc."
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <input
                                            ...
                                            onChange={handleChange}
                                            placeholder="e.g. Mumbai - Goa - Mumbai"
                                            className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#14532d] focus:border-transparent outline-none transition"
                                            required
                                        />
                                    </div>
                                ...
                                <div className="flex justify-end pt-6 border-t border-gray-100">
                                    <button
                                        type="submit"
                                        disabled={loading}
                                        className={`flex items-center gap-2 px-8 py-3 bg-[#14532d] text-white rounded-lg font-bold hover:bg-[#0f4a24] transition shadow-md ${loading ? 'opacity-50 cursor-not-allowed' : ''}`}
                                    >
                                        {loading ? (
...
export default CruiseCalendarAdd;
