                ...
                <div className="flex-1 overflow-y-auto p-6">
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
                            <h1 className="text-xl font-black text-gray-900 mb-8 uppercase tracking-widest">Edit Country</h1>
                            ...
                            {loading ? (
                                <div className="py-12 text-center text-gray-400 font-medium italic">Loading country data...</div>
                            ) : (
