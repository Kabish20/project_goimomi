...
const CountryEdit = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setError("Failed to update country. Perhaps the name already exists?");
        } finally {
            setSaving(false);
        }
    };
        ...
        <div className="flex bg-[#fcfdfc] h-screen overflow-hidden font-outfit">
            ...
            <div className="flex-1 flex flex-col h-full overflow-hidden">
                ...
                <div className="bg-white border-b border-gray-100 px-8 py-4 flex justify-between items-center z-10 shadow-sm backdrop-blur-md bg-opacity-90">
                    <div>
                        <h1 className="text-xl font-black text-gray-900 tracking-tighter uppercase">Edit Country</h1>
                        <p className="text-[9px] text-gray-400 font-black uppercase tracking-[0.3em] leading-none mt-1.5 flex items-center gap-2">
                            <span className="text-green-500">Geography</span> / <span>Inventory</span> / <span className="text-gray-900">Modified Entry</span>
                        </p>
                    </div>
                </div>
                        ...
                        <div className="bg-white rounded-[2rem] shadow-xl shadow-green-900/[0.03] border border-gray-100 overflow-hidden">
                            <div className="p-10">
                                <div className="flex items-center gap-4 mb-10">
                                    ...
                                    <div>
                                        <h2 className="text-lg font-black text-gray-900 tracking-tight leading-none">Global Profile</h2>
                                        <p className="text-[10px] text-gray-400 font-bold uppercase tracking-widest mt-1.5">Territorial Information</p>
                                    </div>
                                </div>
                                ...
                                {loading ? (
                                    <div className="py-20 text-center">
                                        <div className="animate-spin rounded-full h-10 w-10 border-4 border-[#14532d]/10 border-t-[#14532d] mx-auto mb-4"></div>
                                        <p className="text-gray-400 font-black text-[10px] uppercase tracking-widest">Retransmitting Assets...</p>
                                    </div>
                                ) : (
