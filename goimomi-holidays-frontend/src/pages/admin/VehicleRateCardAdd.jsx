...
const VehicleRateCardAdd = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (rateCard.supplier) fd.append("supplier", rateCard.supplier);
            ...
            await api.post("/api/vehicle-rate-cards/", fd, {
                ...
                <div className="flex-1 overflow-y-auto p-4 md:p-6 text-gray-800">
                    <div className="max-w-6xl mx-auto">
                        ...
                        {currentStep === 1 ? (
                            ...
                            <div className="space-y-6">
                                {/* Compact File Upload */}
                                <div className="mt-4 flex items-center gap-4 bg-white rounded-xl p-2.5 border border-gray-100 shadow-sm max-w-lg mb-6">
                                                ...
                                                {rateCard.routes.map((route, idx) => (
                                                    <tr key={idx} className="group hover:bg-gray-50/50 transition-colors">
                                                        ...
                                                        <td className="p-1.5 text-center">
                                                            <button onClick={() => removeRouteRow(idx)} className="p-1.5 text-gray-300 hover:text-red-500 rounded-lg">
                                                                <Trash2 size={12} />
                                                            </button>
                                                        </td>
                                                    </tr>
