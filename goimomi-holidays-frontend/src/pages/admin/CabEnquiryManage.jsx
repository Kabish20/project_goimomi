                        ...
                        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
                            <div className="bg-white rounded-2xl shadow-2xl max-w-lg w-full overflow-hidden animate-in fade-in zoom-in duration-200">
                                <div className="bg-[#14532d] p-6 text-white flex justify-between items-center">
                                    <h2 className="text-xl font-bold">Cab Enquiry Details</h2>
                                    <button
                                ...
                                <div className="p-8 space-y-6">
                                    <div className="grid grid-cols-2 gap-6">
                                        ...
                                        <div className="space-y-1">
                                            ...
                                            <p className="font-semibold text-[#14532d] flex items-center gap-1">
                                                <MapPin size={14} /> {selectedEnquiry.destination}
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="space-y-1">
                                        <p className="text-xs font-bold text-gray-400 uppercase">Requirement Description</p>
                                    ...
                                    <div className="pt-4 border-t border-gray-100 text-center">
                                        <p className="text-xs text-gray-400">Received on {formatDate(selectedEnquiry.created_at)}</p>
                                    </div>
                                </div>
                                ...
                                <div className="p-6 bg-gray-50 flex gap-3">
                                    ...
                                    <button
                                        ...
                                        className="flex-1 bg-[#14532d] text-white py-3 rounded-xl font-bold hover:bg-[#0d2f1f] transition-colors shadow-lg shadow-[#14532d]/20"
                                    >
                                        Call Customer
                                    </button>
                                </div>
