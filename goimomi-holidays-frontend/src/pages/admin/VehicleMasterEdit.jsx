...
const VehicleMasterEdit = () => {
    ...
    const detectVehicleCount = (routes) => {
        ...
        const firstRow = routes[0];
        let maxV = 0;
        for (let i = 1; i <= MAX_VEHICLES; i++) {
            if (`v${i}` in firstRow) maxV = i;
            else break;
        }
        return Math.max(1, maxV || 4);
    };
                        ...
                        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-8">
                            <div>
                                <h1 className="text-2xl font-black text-gray-900 tracking-tight leading-none mb-2 uppercase">
                                    {currentStep === 1 ? "Edit Vehicle" : currentStep === 2 ? "Rate Card Configuration" : "Vehicle Route Pricing"}
                                </h1>
                                <p className="text-gray-400 text-[10px] font-bold uppercase tracking-widest">
                                    {currentStep === 1 ? "Update existing vehicle specifications" : currentStep === 2 ? "Set validity and supplier details" : "Define route-based pricing matrix"}
                                </p>
                            </div>
                            <button
                            ...
                            >
                                {loading ? "Saving..." : (currentStep < 3 ? "Next" : "Save Changes")}
                            </button>
                        </div>
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                            ...
                                            <div className="md:col-span-2">
                                                ...
                                                <textarea
                                                    ...
                                                    onChange={handleInputChange}
                                                    rows="4"
                                                    placeholder="Tell something about this vehicle..."
                                        ...
                                        <div className="aspect-[4/3] w-full bg-gray-50 rounded-2xl border-2 border-dashed border-gray-200 flex flex-col items-center justify-center relative overflow-hidden group hover:border-[#14532d]/30 transition-colors">
                                            {preview ? (
                                                ...
                                                <div className="text-center p-6">
                                                    ...
                                                    <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest">Upload Car Photo</p>
                                                </div>
                                            )}
                            ...
                            <div className="space-y-6 max-w-5xl mx-auto pb-12">
                                <section ref={routeMatrixRef} className="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
                                    <div className="p-8 pb-0 flex items-center justify-between">
                                        ...
                                        <button onClick={addRouteRow} className="flex items-center gap-2 bg-[#14532d]/5 text-[#14532d] px-4 py-2 rounded-xl font-black text-[9px] uppercase tracking-widest hover:bg-[#14532d] hover:text-white transition-all">
                                                            ...
                                                            <div className="flex flex-col gap-2">
                                                                <div className="flex items-center justify-center gap-1.5 pt-1">
                                                                    ...
                                                                    <div className="flex items-center gap-1.5 ml-1 scale-90">
                                                                        <button type="button" onClick={(e) => { e.preventDefault(); e.stopPropagation(); removeVehicle(i); }} disabled={vehicleCount <= 1} className="w-5 h-5 rounded hover:bg-red-100 text-gray-500 hover:text-red-600 flex items-center justify-center transition-all disabled:opacity-20 disabled:cursor-not-allowed bg-white shadow-sm border border-gray-100"><Minus size={12} strokeWidth={3} /></button>
                                                                        <button type="button" onClick={(e) => { e.preventDefault(); e.stopPropagation(); addVehicle(); }} disabled={vehicleCount >= MAX_VEHICLES} className="w-5 h-5 rounded hover:bg-green-100 text-gray-500 hover:text-[#14532d] flex items-center justify-center transition-all disabled:opacity-20 disabled:cursor-not-allowed bg-white shadow-sm border border-gray-100"><Plus size={12} strokeWidth={3} /></button>
                                                                    </div>
                                                                </div>
                                                                <SearchableSelect
                                                ...
                                                {rateCard.routes.map((route, idx) => (
                                                    <tr key={idx} className="group hover:bg-gray-50/50 transition-colors">
                                                        ...
                                                        <td className="p-2 text-center">
                                                            <button onClick={() => removeRouteRow(idx)} className="p-2 text-gray-300 hover:text-red-500 rounded-lg"><Trash2 size={14} /></button>
                                                        </td>
                                                    </tr>
                                                ))}
                                            </tbody>
