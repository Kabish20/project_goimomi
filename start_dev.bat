...
start "Goimomi Backend" cmd /k "cd goimomi-holidays-backend && python manage.py runserver 0.0.0.0:8000"

echo Launching React Frontend on http://localhost:5174 ...
start "Goimomi Frontend" cmd /k "cd goimomi-holidays-frontend && npm run dev"
