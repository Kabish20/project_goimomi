...
from .models import (
    ...
    ItineraryMaster, Nationality, UmrahDestination, Visa, VisaApplication, VisaApplicant
)
            ...
            for dest_data in package_destinations_data:
                if dest_data.get('destination'):
                    try:
                        ...
                        PackageDestination.objects.create(package=package, destination=destination, nights=dest_data.get('nights', 1))
