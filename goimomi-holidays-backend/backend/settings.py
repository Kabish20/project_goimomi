...
ZOHO_PAYMENTS_SIGNING_KEY = config("ZOHO_PAYMENTS_SIGNING_KEY", default=ZOHO_WEBHOOK_SECRET)

# Aliases and Fallbacks
ZOHO_CLIENT_ID = config("ZOHO_CLIENT_ID", default=ZOHO_CRM_CLIENT_ID)
ZOHO_CLIENT_SECRET = config("ZOHO_CLIENT_SECRET", default=ZOHO_CRM_CLIENT_SECRET)
ZOHO_REFRESH_TOKEN = config("ZOHO_REFRESH_TOKEN", default=ZOHO_CRM_REFRESH_TOKEN)
ZOHO_ACCOUNT_ID = config("ZOHO_ACCOUNT_ID", default="")
ZOHO_ORGANIZATION_ID = config("ZOHO_ORGANIZATION_ID", default=ZOHO_ACCOUNT_ID)
